...
/** Quinta sección — diseño Skiper19 en flujo normal del documento */
export const SvgFollowScroll = forwardRef<HTMLElement, SvgFollowScrollProps>(
  function SvgFollowScroll({ className }, ref) {
    ...
    return (
      <section
        ref={setRef}
        data-svg-follow-scroll
        data-light-surface
        className={cn(
          "relative z-[170] mx-auto flex h-[350vh] w-full flex-col items-center overflow-hidden bg-[#FAFDEE] px-4 text-[#1F3A4B]",
          className
        )}
      >
        <div className="relative mt-[10.5rem] flex w-fit flex-col items-center justify-center gap-5 text-center">
          <h1 className="relative z-10 font-[family-name:var(--font-body)] text-7xl font-medium tracking-[-0.08em] lg:text-9xl">
            El trazo que <br /> sigue tu <br />
            recorrido
          </h1>
        ...
        <div className="w-full translate-y-[200vh] rounded-[2rem] bg-[#1F3A4B] pb-10 font-[family-name:var(--font-body)] text-[#FAFDEE]">
