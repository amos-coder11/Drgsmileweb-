...
const themes = {
  dark: {
    serif:
      "font-[family-name:var(--font-serif)] text-[clamp(3.5rem,14vw,11rem)] font-normal uppercase leading-[0.9] tracking-[-0.03em] text-[#6aaeef]/90",
  ...
  light: {
    ...
    sans: "font-[family-name:var(--font-body)] text-[clamp(2.5rem,9vw,7.5rem)] font-bold uppercase leading-[0.85] tracking-[-0.04em] text-[#1a56db]/20",
  },
} as const;
  ...
  return (
    ...
    >
      <VelocityScroll
        default_velocity={4}
        rows={[
          { text: "DISEÑAMOS SONRISAS", className: t.serif, velocity: 4 },
          {
